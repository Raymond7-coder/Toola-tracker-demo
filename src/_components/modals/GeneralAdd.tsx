...
export default function GeneralAdd({ open, onClose, type }: Props) {
    return (
            ...
            >
                ...
                <div className="flex flex-col items-left">
                    <div className="mt-3 text-center sm:text-left">
                        <DialogTitle as="h3" className="text-sm md:text-base font-semibold text-gray-900 capitalize">
                            Add {type.replace("_", " ")} 
                        </DialogTitle>
                        <p className="text-xxs sm:text-xs md:text-xs 2xl:text-sm text-gray-500 mb-4">
                            Please fill the form to add a new {type.replace("_", " ")}.
                        </p>
                        <form action="" className='mt-2 flex flex-col gap-y-3'>
                            <div className='flex flex-col gap-y-0.5'>
                                <label htmlFor="" className='text-xs font-medium text-gray-600 capitalize'>{type.replace("_", " ")} Name</label>
                            ...
                            <div className='flex flex-col gap-y-0.5'>
                                <label htmlFor="" className='text-xs font-medium text-gray-600'>Description</label>
                                <input type="text" className='border border-gray-200 w-full rounded-sm  px-2 py-1.5 text-xxs md:text-xs outline-none focus:border-green-600'/>
                            </div>
