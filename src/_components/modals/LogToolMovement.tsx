...
export default function LogToolMovement({ open, onClose, name }: Props) {
                ...
                <div className="flex flex-col items-left">
                    <div className="mt-3 text-center sm:text-left">
                        <DialogTitle as="h3" className="text-sm md:text-base font-semibold text-gray-900">
                            Log Movement of {name} 
                        </DialogTitle>
                        <p className="text-xxs sm:text-xs md:text-xs 2xl:text-sm text-gray-500 mb-4">
                            Please fill the forms correctly to log the movement of this tool.
                        </p>
                        <form action="" className='mt-2 flex flex-col gap-y-3'>
                            <div className='flex flex-col gap-y-0.5'>
                                <label htmlFor="" className='text-xs font-medium text-gray-600'>Movement Type</label>
                                <select name="" id="" className='border border-gray-200 w-full rounded-sm  px-2 py-1.5 text-xxs md:text-xs outline-none focus:border-green-600' value={action} onChange={(e) => setAction(e.target.value)}>
                            ...
                            <div className='flex flex-col gap-y-0.5'>
                                <label htmlFor="" className='text-xs font-medium text-gray-600'>Issued By:</label>
                            ...
                            <div className='flex flex-col gap-y-0.5'>
                                <label htmlFor="" className='text-xs font-medium text-gray-600'>Received By:</label>
                                <input type="text" className='border border-gray-200 w-full rounded-sm  px-2 py-1.5 text-xxs md:text-xs outline-none focus:border-green-600'/>
                            </div>
                            <div className='flex flex-col gap-y-0.5'>
                                <label htmlFor="" className='text-xs font-medium text-gray-600'>Condition Before:</label>
                            ...
                            <div className='flex flex-col gap-y-0.5'>
                                <label htmlFor="" className='text-xs font-medium text-gray-600'>Condition After:</label>
                                <select name="" id="" className='border border-gray-200 w-full rounded-sm  px-2 py-1.5 text-xxs md:text-xs outline-none focus:border-green-600'>
                                    <option value="">Select Condition</option>
                                    <option value="good">Good</option>
                                    <option value="fair">Fair</option>
                            ...
                            <div className='flex flex-col gap-y-0.5'>
                                <label htmlFor="" className='text-xs font-medium text-gray-600'>Notes:</label>
                                <input type="text" className='border border-gray-200 w-full rounded-sm  px-2 py-1.5 text-xxs md:text-xs outline-none focus:border-green-600'/>
                            </div>
                        </form>
